...
export type IsActiveRouteByComponentFunction = (component: PageComponent<any>) => boolean;
 ...
 * @returns
 */
export function isActiveRouteByComponentWrapper(router: Router): IsActiveRouteByComponentFunction {
