...
export type PageParserArrayify<Income, Outcome> = PageParserSimple<Income[], Outcome[]>;

export type PageParser<Income, Outcome> = PageParserSimple<Income, Outcome> | PageParserArrayify<Income, Outcome>;
