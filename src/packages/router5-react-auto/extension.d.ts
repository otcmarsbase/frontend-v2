...
declare module 'router5/dist/types/router' {
  export interface Router {
    ...
    routes: Route[];
    navigateComponent<Props>(component: RouterComponent<Props>, props: Props, options?: NavigationOptions, done?: DoneFn): CancelFn;
    buildPathComponent<Props>(component: RouterComponent<Props>, props?: Props): string;
  }
