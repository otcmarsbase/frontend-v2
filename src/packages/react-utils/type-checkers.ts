...
export function isReactComponentClass(
  ...
  return (
    typeof component === 'function' && isExtends(component, React.Component)
  );
}
...
export function isReactComponentType(
  component: any,
): component is React.ComponentClass | React.FC {
  return isReactComponentClass(component) || isReactFC(component);
}

export function isReactComponentTypeComposite(
  component: any,
): component is React.ComponentClass | React.FC {
  return (
    ...
    (typeof component === 'object' &&
      component &&
      isReactComponentType(component.type))
  );
}
...
export function isReactElementTypeDOM(
  element: any,
): element is React.ReactElement {
  return isReactElement(element) && typeof element.type === 'string';
}

export function isReactElementTypeComposite(
  element: any,
): element is React.ReactElement {
