...
export namespace LotAttributes {
  ...
  export type COMMON_OFFER_MAKER_TYPES_ATTRIBUTE = Utils.Attribute<
    'COMMON_OFFER_MAKER_TYPES_ATTRIBUTE',
    Common.Enums.InvestorType[]
  >;
  export type COMMON_BID_MAKER_TYPES_ATTRIBUTE = Utils.Attribute<
    'COMMON_BID_MAKER_TYPES_ATTRIBUTE',
    Common.Enums.InvestorType[]
  >;
  export type COMMON_UNITS_ATTRIBUTE = Utils.Attribute<'COMMON_UNITS_ATTRIBUTE', Common.Finances.UnitQuantity>;
  export type COMMON_SUMMARY_ATTRIBUTE = Utils.Attribute<
    'COMMON_SUMMARY_ATTRIBUTE',
    Common.Finances.StablecoinQuantity
  >;
  export type COMMON_MIN_FILTER_UNITS_ATTRIBUTE = Utils.Attribute<
    'COMMON_MIN_FILTER_UNITS_ATTRIBUTE',
    Common.Finances.UnitQuantity
  >;
  export type COMMON_MIN_FILTER_SUMMARY_ATTRIBUTE = Utils.Attribute<
    'COMMON_MIN_FILTER_SUMMARY_ATTRIBUTE',
    Common.Finances.StablecoinQuantity
  >;
  ...
  export type COMMON_COMPLETED_REASON_ATTRIBUTE = Utils.Attribute<
    'COMMON_COMPLETED_REASON_ATTRIBUTE',
  ...
  export type INVEST_DOC_ASSET_CREATE_REQUEST_ATTRIBUTE = Utils.Attribute<
    'INVEST_DOC_ASSET_CREATE_REQUEST_ATTRIBUTE',
  ...
  export type INVEST_DOC_FDV_ATTRIBUTE = Utils.Attribute<
    'INVEST_DOC_FDV_ATTRIBUTE',
    Common.Finances.StablecoinQuantity
  >;
  export type INVEST_DOC_SHARE_ATTRIBUTE = Utils.Attribute<'INVEST_DOC_SHARE_ATTRIBUTE', Common.Finances.Percent>;

  //  Только при SELL
  export type INVEST_DOC_ROUND_TYPE_ATTRIBUTE = Utils.Attribute<
    'INVEST_DOC_ROUND_TYPE_ATTRIBUTE',
    Common.Enums.InvestRound
  >;
  export type INVEST_DOC_ROUND_PRICE_ATTRIBUTE = Utils.Attribute<
    'INVEST_DOC_ROUND_PRICE_ATTRIBUTE',
    Common.Finances.Price
  >;
  export type INVEST_DOC_ROUND_UNITS_ATTRIBUTE = Utils.Attribute<
    'INVEST_DOC_ROUND_UNITS_ATTRIBUTE',
    Common.Finances.UnitQuantity
  >;
  export type INVEST_DOC_ROUND_FDV_ATTRIBUTE = Utils.Attribute<
    'INVEST_DOC_ROUND_FDV_ATTRIBUTE',
    Common.Finances.StablecoinQuantity
  >;
  export type INVEST_DOC_ROUND_SHARE_ATTRIBUTE = Utils.Attribute<
    'INVEST_DOC_ROUND_SHARE_ATTRIBUTE',
    Common.Finances.Percent
  >;
  export type INVEST_DOC_ROUND_SUMMARY_ATTRIBUTE = Utils.Attribute<
    'INVEST_DOC_ROUND_SUMMARY_ATTRIBUTE',
    Common.Finances.StablecoinQuantity
  >;
  ...
  export type TOKEN_LOCKUP_PERIOD_ATTRIBUTE = Utils.Attribute<
    'TOKEN_LOCKUP_PERIOD_ATTRIBUTE',
    Common.Text.LockupPeriod
  >;
  export type TOKEN_VESTING_PERIOD_ATTRIBUTE = Utils.Attribute<
    'TOKEN_VESTING_PERIOD_ATTRIBUTE',
    Common.Text.VestingPeriod
  >;
}
