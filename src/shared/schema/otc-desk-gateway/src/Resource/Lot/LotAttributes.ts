...
export namespace LotAttributes {
  ...
  export type COMMON_OFFER_MAKER_TYPES_ATTRIBUTE = Utils.Attribute<'LOT_COMMON_OFFER_MAKER_TYPES_ATTRIBUTE', Common.Enums.InvestorType[]>;
  export type COMMON_BID_MAKER_TYPES_ATTRIBUTE = Utils.Attribute<'LOT_COMMON_BID_MAKER_TYPES_ATTRIBUTE', Common.Enums.InvestorType[]>;
  export type COMMON_UNITS_ATTRIBUTE = Utils.Attribute<'LOT_COMMON_UNITS_ATTRIBUTE', Common.Finances.UnitQuantity>;
  export type COMMON_SUMMARY_ATTRIBUTE = Utils.Attribute<'LOT_COMMON_SUMMARY_ATTRIBUTE', Common.Finances.StablecoinQuantity>;
  export type COMMON_MIN_FILTER_UNITS_ATTRIBUTE = Utils.Attribute<'LOT_COMMON_MIN_FILTER_UNITS_ATTRIBUTE', Common.Finances.UnitQuantity>;
  export type COMMON_MIN_FILTER_SUMMARY_ATTRIBUTE = Utils.Attribute<'LOT_COMMON_MIN_FILTER_SUMMARY_ATTRIBUTE', Common.Finances.StablecoinQuantity>;

  export type COMMON_CREATED_AT_ATTRIBUTE = Utils.Attribute<'LOT_COMMON_CREATED_AT_ATTRIBUTE', number>;
  export type COMMON_SEND_ON_MODERATION_AT_ATTRIBUTE = Utils.Attribute<'LOT_COMMON_SEND_ON_MODERATION_AT_ATTRIBUTE', number>;
  export type COMMON_PUBLISHED_AT_ATTRIBUTE = Utils.Attribute<'LOT_COMMON_PUBLISHED_AT_ATTRIBUTE', number>;

  // Only when archived
  export type COMMON_ARCHIVED_AT_ATTRIBUTE = Utils.Attribute<'LOT_COMMON_ARCHIVED_AT_ATTRIBUTE', number>;

  // Only when completed
  export type COMMON_COMPLETED_AT_ATTRIBUTE = Utils.Attribute<'LOT_COMMON_COMPLETED_AT_ATTRIBUTE', number>;
  export type COMMON_COMPLETED_REASON_ATTRIBUTE = Utils.Attribute<'LOT_COMMON_COMPLETED_REASON_ATTRIBUTE', Lot.Enums.LotCompletedReasonType>;

  // Only when rejected
  export type COMMON_REJECTED_AT_ATTRIBUTE = Utils.Attribute<'COMMON_REJECTED_AT_ATTRIBUTE', number>;
  export type COMMON_REJECT_REASON_ATTRIBUTE = Utils.Attribute<'LOT_COMMON_REJECT_REASON_ATTRIBUTE', string>;
  ...
  export type SAFE_CATEGORY_WITH_TOKEN_WARRANT_ATTRIBUTE = Utils.Attribute<'SAFE_CATEGORY_WITH_TOKEN_WARRANT_ATTRIBUTE', boolean>;

  export type TOKEN_CATEGORY_TGE_ATTRIBUTE = Utils.Attribute<'TOKEN_CATEGORY_TGE_ATTRIBUTE', Common.Dates.TGE>;
  export type TOKEN_CATEGORY_LOCKUP_PERIOD_ATTRIBUTE = Utils.Attribute<'TOKEN_CATEGORY_LOCKUP_PERIOD_ATTRIBUTE', Common.Text.LockupPeriod>;
  export type TOKEN_CATEGORY_VESTING_PERIOD_ATTRIBUTE = Utils.Attribute<'TOKEN_CATEGORY_VESTING_PERIOD_ATTRIBUTE', Common.Text.VestingPeriod>;
}
