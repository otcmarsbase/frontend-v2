...
export namespace Lot {
  ...
  export type LotContent = SchemaCommon.Merge<[LotBase.LotTypeModel<'SAFE', LotSAFE.State>, LotBase.LotTypeModel<'SAFT', LotSAFT.State>, LotBase.LotTypeModel<'TOKEN_WARRANT', LotTokenWarrant.State>]>;
}
