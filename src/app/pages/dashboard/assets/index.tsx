...
import {AssetsSchema} from "@app/pages/dashboard/assets/constants";
import {HeaderItemChip} from "@app/pages/dashboard/assets/HeaderItemChip";
import {HeaderTitleChip} from "@app/pages/dashboard/assets/HeaderTitleChip";
import {AssetMock} from "@app/pages/dashboard/assets/mocks";
import {useViewControl} from "@app/pages/dashboard/assets/useViewControl";
...
export const MyBids: React.FC<IMyDibsPageParams> = observer(() => {
                ...
                <TabPanels>
                    <TabPanel>
                        <SimpleGrid columns={columnsCount === 4 ? 1 : 2}
                            ...
                            {columnsCount === 3 && (
                                <VStack w="20rem" paddingTop='10px' gap='1.25rem'>
                                    <HStack w='100%'>
