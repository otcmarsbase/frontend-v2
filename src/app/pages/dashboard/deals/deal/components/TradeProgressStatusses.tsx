    ...
    return (
        ...
        >
            ...
            <VStack gap='0.75rem' w='100%'>
                ...
                >
                    <TradeProgressChip label={TRADE_PROGRESS_LABELS.chatCreating}
                                       status={TRADE_PROGRESS_STATUS_ICONS[chatCreating]}/>
                    <TradeProgressChip label={TRADE_PROGRESS_LABELS.offerMakerValidation}
                                       status={TRADE_PROGRESS_STATUS_ICONS[offerMakerValidation]}/>
                    <TradeProgressChip label={TRADE_PROGRESS_LABELS.bidMakerValdiation}
                ...
                >
                    <TradeProgressChip label={TRADE_PROGRESS_LABELS.KYCValidation}
                                       status={TRADE_PROGRESS_STATUS_ICONS[KYCValidation]}/>
                    <TradeProgressChip label={TRADE_PROGRESS_LABELS.AMLValidation}
                                       status={TRADE_PROGRESS_STATUS_ICONS[AMLValidation]}/>
                    <TradeProgressChip label={TRADE_PROGRESS_LABELS.KYBValidation}
                ...
                >
                    <TradeProgressChip label={TRADE_PROGRESS_LABELS.docOwnership}
                                       status={TRADE_PROGRESS_STATUS_ICONS[docOwnership]}/>
                    <TradeProgressChip label={TRADE_PROGRESS_LABELS.docReAssigned}
                ...
                >
                    <TradeProgressChip label={TRADE_PROGRESS_LABELS.txPayment}
                                       status={TRADE_PROGRESS_STATUS_ICONS[txPayment]}/>
                    <TradeProgressChip label={TRADE_PROGRESS_LABELS.MarsComission}
                                       status={TRADE_PROGRESS_STATUS_ICONS[MarsComission]}/>
                    <TradeProgressChip label={TRADE_PROGRESS_LABELS.OTCComission}
