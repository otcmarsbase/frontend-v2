...
export const StepThree: FC<{
  ...
  return (
    <VStack bg={'orange'}>
      <Box>Pricing model</Box>
      <VStack>
        <HStack>
          <Button onClick={() => switchPricingModel(leftBtnLabel)}>
            {leftBtnLabel}
          </Button>
          <Button onClick={() => switchPricingModel(rightBtnLabel)}>
            {rightBtnLabel}
          </Button>
        </HStack>
          ...
          <HStack>
            <FormControl>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleRecountValues(e.currentTarget.id, e.currentTarget.value)
                }
              />
            </FormControl>
        ...
        <HStack>
          <FormControl>
            ...
            <Input
              ...
              onChange={(e) =>
                handleRecountValues(
                  { currentID: 'targetFDV', bindedID: bottomFieldID },
          ...
          <FormControl>
            <FormLabel>
              {STEP_THREE_TOTAL_FIELDS_BY_LOT_TYPE[lotType].fieldLabel}
            </FormLabel>
            <Input
              placeholder={'Amount'}
              ...
              onChange={(e) =>
                handleRecountValues(
                  { currentID: e.currentTarget.id, bindedID: 'targetFDV' },
                  e.currentTarget.value,
                )
              }
            />
