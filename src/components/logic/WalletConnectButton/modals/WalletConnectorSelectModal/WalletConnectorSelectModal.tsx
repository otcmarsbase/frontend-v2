...
export interface WalletConnectorSelectModalProps
  extends PortalProps<Connector> {}

export function WalletConnectorSelectModal({
  portal,
}: WalletConnectorSelectModalProps) {
  const {
    connect,
